...
export function defaultMilks() {
  return [
    ...
    {
      // Bobbie publishes DHA 20 mg, iron 1.2 mg and vitamin D 75 IU per 100 kcal;
      // at 20 kcal/fl oz (67.6 kcal/100 mL) those become the figures below.
      id: 'bobbie-original', name: 'Bobbie Organic Original', emoji: '\u{1F37C}', kind: 'formula', builtin: true,
      per100: { kcal: 67.6, protein: 1.4, fat: 3.6, carbs: 7.3, iron: 0.81, calcium: 51, vitaminD: 1.27, dha: 13.5, sodium: 18 },
    },
    {
